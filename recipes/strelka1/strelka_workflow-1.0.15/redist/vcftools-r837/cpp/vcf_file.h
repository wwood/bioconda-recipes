...
private:
	...
	void calc_hap_r2(vcf_entry &e, vcf_entry &e2, const vector<bool> &include_geno1, const vector<bool> &include_geno2, double &r2, double D, double &Dprime, int &chr_count);
	void calc_geno_r2(vcf_entry &e, vcf_entry &e2, const vector<bool> &include_geno1, const vector<bool> &include_geno2, double &r2, int &chr_count);
	void calc_r2_em(vcf_entry &e, vcf_entry &e2, const vector<bool> &include_geno1, const vector<bool> &include_geno2, double &r2, int &indv_count);
