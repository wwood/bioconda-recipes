...
void vcf_file::output_LDhat_locs_file(const string &output_file_prefix, unsigned int &n_sites_out)
{
...
void vcf_file::output_as_LDhat_phased(const string &output_file_prefix)
{
	if (has_genotypes == false)
...
void vcf_file::output_as_LDhat_unphased(const string &output_file_prefix)
{
	if (has_genotypes == false)
		LOG.error("Require Genotypes in VCF file in order to output LDhat format.");
...
void vcf_file::output_BEAGLE_genotype_likelihoods(const string &output_file_prefix, int GL_or_PL)
{
	if (has_genotypes == false)
